...
def create_default_issue(pkg_info):
  ...
  try:
    ...
    params = {'title':'Vetting process: Please read this','description':'Thank you for uploading the library item. You should have received a confirmation email from OD Mekong Datahub. This library item is still unpublished. Your item can only be published after you review this form and after our administrators approve your entry.**It is important that you have entered the correct information in your library record form. We also ask that all contributors complete as many fields as possible.**Please take this opportunity to review your library record. If you would like to make any changes please select your library record and then click on the Manage button on the top right corner.1.  Please CHECK YOUR SPELLING against the original item to ensure the item is recorded correctly.2.  Please review your library record form again for the mandatory fields:*   Title (Please use Associated Press style title where the first letter is capitalized and the rest of the title is not, i.e. "Study of Cambodian forests and lakes from 1992 to 1994")*   Language*   Edition / Version*   Geographical area*   Date uploaded4.  Please review again the following information, vital to other users who may search for your record:*   Summary (Make sure this is a concise description of the record in your own words, please do not just copy and paste an abstract by the original author)*   Topics*   License (Make sure you indicated the correct license. Additional information on creative commons is found here http://opendefinition.org/licenses/. If there is no license, please indicate license unspecified)*   Copyright*   Access and Use Constraints*   Author*   Co-author*   Corporate Author*   Publisher6.  Lastly, please check again for the following information on the library record you entered. If the information is available, please include it in the appropriate field. This will greatly improve the searchability of your library record item or provide information that a user will find useful:*   ISSN or ISBN numbers*   Publication Place*   Publication Date*   PaginationOur administrators need to review the library record as well. They will close fixed issues or open new issues if there are any other inconsistencies. Once all issues have been closed, the item will be published.Thank you for sharing,Open Development Team','dataset_id':pkg_info['id']}
